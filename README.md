...
> Core AI infrastructure engine for model serving and pipeline orchestration - part of the [MatrixInfrastructure](https://github.com/MatrixInfrastructure) open-source ecosystem.
...
This repository contains the `core` component, which handles the core runtime responsibilities for MatrixInfrastructure.
...
```bash
git clone https://github.com/MatrixInfrastructure/core
cd core
go mod download
```
